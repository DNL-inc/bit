...
@get_current_user()
@dp.callback_query_handler(back_callback.filter(category='lang'), state=settings.SettingsStates.lang)
async def back_choose_lang(callback: types.CallbackQuery, state: FSMContext, user: User):
